...
import { ROW_CONTENT_CONTAINER_CLASS_NAME } from '../rankingList'
import style from './RankingListItem.module.scss'
 ...
 * プレイヤー一人分のコンポーネント
 */
export const RankingListItem: JSXFunc<Props> = ({ rank, playerName, coinValue }: Props) => {
  let rankColorClass = ''
  // 順位に応じて色を設定
  if (rank === 1) {
