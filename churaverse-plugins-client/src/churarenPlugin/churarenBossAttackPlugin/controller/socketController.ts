...
import { ChurarenWeaponDamageMessage } from '../message/churarenWeaponDamageMessage'
...
export class SocketController extends BaseSocketController<IMainScene> {
  ...
  public registerMessageListener(): void {
    ...
    this.messageListenerRegister.on('weaponDamage', this.bossAttackDamage)
  }
  ...
  public unregisterMessageListener(): void {
    ...
    this.messageListenerRegister.off('weaponDamage', this.bossAttackDamage)
  }
  ...
  private readonly bossAttackDamage = (msg: ChurarenWeaponDamageMessage): void => {
    const data = msg.data
